...
- Keep in mind that this list is relatively new, so we are looking for high quality things we've missed to add to the list.
...
- Link to the GitHub repo or the project's site, not the Discord server.
